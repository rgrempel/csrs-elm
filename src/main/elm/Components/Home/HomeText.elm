module Components.Home.HomeText where

import Language.LanguageTypes exposing (Language(EN, FR, LA))

import Components.FocusTypes exposing (address, Action(FocusAccount))
import Components.Account.AccountTypes exposing (Action(FocusLogin, FocusRegister))
import Components.Account.Login.LoginTypes as LoginTypes exposing (Action(FocusBlank))
import Components.Account.Register.RegisterTypes as RegisterTypes exposing (Action(FocusBlank))
